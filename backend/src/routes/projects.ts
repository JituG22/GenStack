 ...
 * /api/projects:
 *   get:
 *     summary: Get all projects for user's organization
 *     description: Retrieve paginated list of projects with optional search and filtering
 *     tags: [Projects]
 *     security:
 *       - bearerAuth: []
 *       - cookieAuth: []
 ...
 *         schema:
 *           type: string
 *         description: Search term for project name, description, or tags
 *       - in: query
 *         name: status
 *         schema:
 *           type: string
